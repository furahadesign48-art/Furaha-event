...
const GuestCheckin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50 pb-20">
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-4 border border-emerald-100">
              ...
              <p className="text-emerald-700 text-sm font-medium">Présents</p>
            </div>
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-4 rounded-2xl border border-gray-200 shadow-sm focus:border-amber-500 focus:ring-2 focus:ring-amber-200 focus:outline-none text-lg"
              autoFocus
            />
          </div>
        </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="text-xl font-bold text-gray-800">{guest.nom}</h3>
                      {guest.checkedIn && (
                    ...
                    <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                      ...
                      {guest.selectedDrink && (
                        <div className="flex items-center gap-1.5">
                          ...
                          <span>Boisson: <strong>{guest.selectedDrink}</strong></span>
                        </div>
                      )}
                    ...
                    {guest.checkedInAt && (
                      <div className="mt-2 flex items-center gap-1 text-xs text-gray-400">
                        ...
                        Check-in: {guest.checkedInAt.toDate().toLocaleString('fr-FR')}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex flex-col gap-2">
                    {guest.checkedIn ? (
                      <button 
                        ...
                        className="px-4 py-2 bg-gray-100 text-gray-600 rounded-xl hover:bg-gray-200 transition font-medium"
                      >
                        Annuler
                      </button>
                    ) : (
                      <button 
                        ...
                        className="px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl hover:from-emerald-600 hover:to-teal-600 transition font-bold shadow-md"
                      >
                        Check-in
                      </button>
                    )}
      ...
      {/* Toast */}
      {toast && (
        <div className={`fixed bottom-6 left-1/2 -translate-x-1/2 z-50 px-6 py-4 rounded-2xl shadow-xl border-2 ${
          toast.type === 'success' ? 'bg-emerald-50 border-emerald-200' : 'bg-red-50 border-red-200'
        }`}>
          <div className="flex items-center gap-3">
            {toast.type === 'success' ? (
              <CheckCircle2 className={`w-6 h-6 ${toast.type === 'success' ? 'text-emerald-500' : 'text-red-500'}`} />
            ) : (
