...
import { Gift, Calendar, MapPin, Users, Cake, Camera, MessageCircle, QrCode, ArrowLeft, Check, Star, Sparkles, Music, User, Eye, Bell } from 'lucide-react';
                ...
                <div className="relative w-80 h-[700px] bg-gradient-to-br from-slate-900 to-slate-800 rounded-[3rem] p-6 shadow-luxury border border-slate-700">
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="flex items-center justify-center text-purple-200">
                      ...
                      <div className="text-center">
                        <p className="text-xs">{templateData.eventLocation}</p>
                        {templateData.eventAddress && (
                          <p className="text-[10px] text-purple-300/80 mt-1">{templateData.eventAddress}</p>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-purple-900/50 to-purple-800/50 backdrop-blur-sm rounded-2xl p-4 mb-4 border border-purple-500/30">
                    ...
                    {permission !== 'granted' && (
                      <button
                        ...
                        className="w-full mt-3 py-2 rounded-xl border border-purple-500/30 text-purple-200 text-xs font-medium hover:bg-purple-500/10 transition-all duration-300 flex items-center justify-center"
                      >
                        <Bell className={`h-3 w-3 mr-2 ${isNotificationLoading ? 'animate-bounce' : ''}`} />
                        {isNotificationLoading ? 'Activation...' : 'M\'alerter pour le jour J'}
                      </button>
                    )}
                  </div>
